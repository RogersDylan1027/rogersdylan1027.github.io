/* My Dashboard · Service Worker · Version 0.10.6 · Reliable Admin Notifications & Notification Center · 2026-09-23 */
const CACHE_NAME = "my-dashboard-v0.10.6";
...
self.addEventListener("push", event => {
  ...
  const options = {
    ...
    icon: BASE_PATH + "logo-app.png?v=0.10.6",
    badge: BASE_PATH + "logo-app.png?v=0.10.6",
