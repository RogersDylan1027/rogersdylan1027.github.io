/* My Dashboard · Service Worker · Version 0.10.5 · Account Request & Signup Initialization Fix · 2026-09-23 */
const CACHE_NAME = "my-dashboard-v0.10.5";
...
self.addEventListener("push", event => {
  ...
  const options = {
    ...
    icon: BASE_PATH + "logo-app.png?v=0.10.5",
    badge: BASE_PATH + "logo-app.png?v=0.10.5",
