...
const CACHE_NAME = "my-dashboard-v0.10.7-pushserverfix";
...
self.addEventListener("push", event => {
  ...
  const options = {
    ...
    icon: BASE_PATH + "logo-app.png?v=0.10.7-pushserverfix",
    badge: BASE_PATH + "logo-app.png?v=0.10.7-pushserverfix",
