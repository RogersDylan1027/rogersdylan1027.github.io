/*
  My Dashboard · Dashboard Entry Guard · Version 0.6.7
  ...
  0.6.7 also loads the authenticated Streaming client and Settings integration
...
(function () {
  ...
  (async function protectDashboard() {
    try {
      ...
      // that final shell before attaching 0.6.7 Streaming UI.
