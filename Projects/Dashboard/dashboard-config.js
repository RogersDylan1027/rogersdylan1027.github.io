/*
  My Dashboard · Shared Configuration · Version 0.6.7
...
(function () {
  ...
  window.DashboardConfig = Object.freeze({
    ...
    streamingClientUrl: BASE_PATH + "dashboard-streaming.js?v=0.6.7",
    streamingUiUrl: BASE_PATH + "dashboard-streaming-ui.js?v=0.6.7"
  });
